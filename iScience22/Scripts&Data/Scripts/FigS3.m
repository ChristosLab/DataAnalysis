...
TEM       = importdata(['ALLTRIALSLFP/ELV_',Task{2},'_',Training{1},'_',Area{1},'_LFP.mat']);
...
TEM       = importdata(['ALLTRIALSLFP/',Hemisphere{1},'_',Task{2},'_',Area{1},'_LFP.mat']);
S_Induced = zeros(66,51);
...
TEM       = importdata(['ALLTRIALSLFP/',Hemisphere{2},'_',Task{2},'_',Area{1},'_LFP.mat']);
S_Induced = zeros(66,51);
...
set(gcf,'renderer','Painters');set(gcf,'name',['Induced_Feature_Left_RightHemiSphere']);
% print(fig,['FigS3.eps'],'-depsc');
% saveas(fig,['FigS3.fig'],'fig' );
% close all;
