...
TEM       = importdata(['ALLTRIALSLFP/',Task{2},'_',Training{1},'_',Area{2},'_LFP.mat']);
...
% %%% Post-Training              
TEM       = importdata(['ALLTRIALSLFP/',Task{2},'_',Training{2},'_',Area{2},'_LFP.mat']);
S_Induced = zeros(66,51);
for tri=1:size(TEM,1)
    TEMP          = TEM(tri,:);
    TEMPBaseline_ = TEM(tri,1:500);
...
TEM       = importdata(['ALLTRIALSLFP/',Task{2},'_',Training{1},'_',Area{1},'_LFP.mat']);
S_Induced = zeros(66,51);
for tri=1:size(TEM,1)
    TEMP          = TEM(tri,:);
    TEMPBaseline_ = TEM(tri,1:500);
...
%%% Post-Training              
TEM       = importdata(['ALLTRIALSLFP/',Task{2},'_',Training{2},'_',Area{1},'_LFP.mat']);
S_Induced = zeros(66,51);
for tri=1:size(TEM,1)
    TEMP          = TEM(tri,:);
    TEMPBaseline_ = TEM(tri,1:500);
...
TEM       = importdata(['ALLTRIALSLFP/',Task{2},'_',Training{1},'_',Area{3},'_LFP.mat']);
S_Induced = zeros(66,51);
for tri=1:size(TEM,1)
    TEMP          = TEM(tri,:);
    TEMPBaseline_ = TEM(tri,1:500);
...
% 
% %%% Post-Training              
TEM       = importdata(['ALLTRIALSLFP/',Task{2},'_',Training{2},'_',Area{3},'_LFP.mat']);
S_Induced = zeros(66,51);
for tri=1:size(TEM,1)
    TEMP          = TEM(tri,:);
    TEMPBaseline_ = TEM(tri,1:500);
...
print(fig,['Fig5.eps'],'-depsc');
saveas(fig,['Fig5.fig'],'fig' );
close all;
