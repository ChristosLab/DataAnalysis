...
%% Posterior Dorsal
Pre_SPD_Alpha   = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{2},'_Alpha_InducedPow_ITI.mat']);
Pos_SPD_Alpha   = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{2},'_Alpha_InducedPow_ITI.mat']);

Pre_SPD_Beta    = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{2},'_Beta_InducedPow_ITI.mat']);
Pos_SPD_Beta    = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{2},'_Beta_InducedPow_ITI.mat']);

Pre_SPD_GammaLo = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{2},'_GammaLo_InducedPow_ITI.mat']);
Pos_SPD_GammaLo = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{2},'_GammaLo_InducedPow_ITI.mat']);

Pre_SPD_GammaHi = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{2},'_GammaHi_InducedPow_ITI.mat']);
Pos_SPD_GammaHi = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{2},'_GammaHi_InducedPow_ITI.mat']);
...
xline(2.5,':','LineWidth',1,'Color',[0 0 0]);
xline(4.0,':','LineWidth',1,'Color',[0 0 0]);
xlabel('Time'); ylabel('Power(dB)'); axis tight; ylim([-2.5 2]);
...
xline(2.5,':','LineWidth',1,'Color',[0 0 0]);
xline(4.0,':','LineWidth',1,'Color',[0 0 0]);
xlabel('Time'); ylabel('Power(dB)');axis tight; ylim([-1 2]);
title('PD-65-100 (Hz)');hold off;
clear Pre_SPD_GammaHi Pos_SPD_GammaHi;

%% Mid-Dorsal
Pre_SMD_Alpha   = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{1},'_Alpha_InducedPow_ITI.mat']);
Pos_SMD_Alpha   = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{1},'_Alpha_InducedPow_ITI.mat']);

Pre_SMD_Beta    = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{1},'_Beta_InducedPow_ITI.mat']);
Pos_SMD_Beta    = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{1},'_Beta_InducedPow_ITI.mat']);

Pre_SMD_GammaLo = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{1},'_GammaLo_InducedPow_ITI.mat']);
Pos_SMD_GammaLo = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{1},'_GammaLo_InducedPow_ITI.mat']);

Pre_SMD_GammaHi = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{1},'_GammaHi_InducedPow_ITI.mat']);
Pos_SMD_GammaHi = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{1},'_GammaHi_InducedPow_ITI.mat']);
...
%% Posterior-Ventral
Pre_SPV_Alpha   = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{3},'_Alpha_InducedPow_ITI.mat']);
Pos_SPV_Alpha   = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{3},'_Alpha_InducedPow_ITI.mat']);

Pre_SPV_Beta    = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{3},'_Beta_InducedPow_ITI.mat']);
Pos_SPV_Beta    = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{3},'_Beta_InducedPow_ITI.mat']);

Pre_SPV_GammaLo = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{3},'_GammaLo_InducedPow_ITI.mat']);
Pos_SPV_GammaLo = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{3},'_GammaLo_InducedPow_ITI.mat']);

Pre_SPV_GammaHi = importdata(['ForLinePlots/',Task{1},'_',Training{1},'_',Area{3},'_GammaHi_InducedPow_ITI.mat']);
Pos_SPV_GammaHi = importdata(['ForLinePlots/',Task{1},'_',Training{2},'_',Area{3},'_GammaHi_InducedPow_ITI.mat']);
...
clear Pre_SPD_GammaHi Pos_SPD_GammaHi;
% 
set(gcf,'renderer','Painters');set(gcf,'name',['SpatialTask_Induced']);
print(fig,['Fig3.eps'],'-depsc');
saveas(fig,['Fig3.fig'],'fig' );
% close all;  
