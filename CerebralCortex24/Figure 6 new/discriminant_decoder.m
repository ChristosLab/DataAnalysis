function [x_time,time_perform,crv_cell,population_response]=discriminant_decoder(win_size,step_size,temp_index, mode)
...
for i=1:length(edge1)
    ...
    OBJ=fitcdiscr(population_response(:,:,i)',decode_label,'DiscrimType','pseudoLinear');
