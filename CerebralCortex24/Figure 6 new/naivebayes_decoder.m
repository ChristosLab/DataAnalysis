function [x_time,time_perform,crv_cell,population_response]=naivebayes_decoder(win_size,step_size,temp_index, mode)
...
for i=1:length(edge1)
    ...
    OBJ=fitcnb(population_response(:,:,i)',decode_label,'DistributionNames','kernel');
