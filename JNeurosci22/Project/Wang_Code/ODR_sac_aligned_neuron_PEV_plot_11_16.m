%%  Young vs. adult ODR sac_aligned (Gamma cue tuning)
inputs = {...
...
fig_name = 'pev_gamma_cue_odr_sac_aligned';
print(gcf, fullfile(project_dir, fig_lib, fig_name), '-dpng', '-r400');
%%  Young vs. adult ODR sac_aligned (Gamma delay tuning)
inputs = {...
...
fig_name = 'pev_gamma_delay_odr_sac_aligned';
print(gcf, fullfile(project_dir, fig_lib, fig_name), '-dpng', '-r400');
%%  Young vs. adult ODR sac_aligned (Beta cue tuning)
inputs = {...
...
fig_name = 'pev_beta_cue_odr_sac_aligned';
print(gcf, fullfile(project_dir, fig_lib, fig_name), '-dpng', '-r400');
%%  Young vs. adult ODR sac_aligned (Beta delay tuning)
inputs = {...
...
fig_name = 'pev_beta_delay_odr_sac_aligned';
print(gcf, fullfile(project_dir, fig_lib, fig_name), '-dpng', '-r400');