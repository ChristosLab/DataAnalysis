%% This script for Spatial PSTH Pretraining-Posttraining (AllRegionInformative-NonInformative) & spectrogram
clc; clear; close all;
default_dir = pwd;
...
subplot(1,3,1); hold on; psth_plot(NEURONDATA, t,'y',linetypes,colormap,Label);hold off; ylim([2.5 11]);
...
subplot(1,3,2); hold on; psth_plot(NEURONDATA, t,'y',linetypes,colormap,Label);hold off;  ylim([3.5 11.5]); 
...
subplot(1,3,3); hold on; psth_plot(NEURONDATA, t,'y',linetypes,colormap,Label); hold off; ylim([3.5 15]); 
...
freqsVector = importdata(['Data&Scripts/Data/Frequency.mat']);
