...
subplot(1,3,1); hold on; psth_plot(NEURONDATA, t,'y',linetypes,colormap,Label); ylim([0 25]); hold off;
...
subplot(1,3,2); hold on; psth_plot(NEURONDATA, t,'y',linetypes,colormap,Label); ylim([1.5 13]); hold off;
clear NEURONDATA PRESEL POSSEL PRENONSEL POSNONSEL ar;
...
subplot(1,3,3); hold on; psth_plot(NEURONDATA, t,'y',linetypes,colormap,Label); ylim([1.5 14]); hold off;
clear NEURONDATA PRESEL POSSEL PRENONSEL POSNONSEL ar;
