%% This script for spectrogram informative, noninformative LFP sites from Match-NonMatch Pretraining
clc; clear; close all;
default_dir=pwd;
...
Pow = importdata(['Data/PowerSpectrum/TrialbyTrial/',Task{tas},'_',Training{1},'_AllRegion_',Info{1},'_LFP_Match.mat']);
...
Pow = importdata(['Data/PowerSpectrum/TrialbyTrial/',Task{tas},'_',Training{1},'_AllRegion_',Info{2},'_LFP_Match.mat']);
...
Pow = importdata(['Data/PowerSpectrum/TrialbyTrial/',Task{tas},'_',Training{1},'_AllRegion_',Info{3},'_LFP_Match.mat']);
...
Pow = importdata(['Data/PowerSpectrum/TrialbyTrial/',Task{tas},'_',Training{1},'_AllRegion_',Info{1},'_LFP_NonMatch.mat']);
...
Pow = importdata(['Data/PowerSpectrum/TrialbyTrial/',Task{tas},'_',Training{1},'_AllRegion_',Info{2},'_LFP_NonMatch.mat']);
...
Pow = importdata(['Data/PowerSpectrum/TrialbyTrial/',Task{tas},'_',Training{1},'_AllRegion_',Info{3},'_LFP_NonMatch.mat']);
