...
for i=1:length(find_index)
   ...
   % cell_info=overlap_spatial_info(find_index(i),:);
    ...
    allcell_info{1}=data_inclusion_index;
allcell_info{2}=find_informative;
allcell_info{3}=find_sigsample_NMS1;
allcell_info{4}=find_sigsample_NMS2;
allcell_info{5}=find_sigsample_NMS3;
allcell_info{6}=find_sigsample_NMS4;
allcell_info{7}=find_sigsample_CS1;
allcell_info{8}=find_sigsample_CS2;
allcell_info{9}=find_sigsample_LMS;
allcell_info{10}=find_index;
allcell_info{11}=find_sigsampledelay_NMS1;
allcell_info{12}=find_sigsampledelay_NMS2;
allcell_info{13}=find_sigsampledelay_NMS3;
allcell_info{14}=find_sigsampledelay_NMS4;
allcell_info{15}=find_sigsampledelay_CS1;
allcell_info{16}=find_sigsampledelay_CS2;
allcell_info{17}=find_sigsampledelay_LMS;
%save allcell_pre.mat allcell_info
...
%save posterior_dorsal_info_post.mat area_info