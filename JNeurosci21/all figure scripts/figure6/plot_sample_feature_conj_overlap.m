...
load feature_sample_f.mat
feature_sample_f=f_sample;
...
load feature_sample_info.mat;
feature_info=category_sample_info;
...
hold on;
title('feature cells');
scatter(ones(1,length(feature_NMS_overlap)),feature_sample_f(find_index(feature_NMS_overlap),3));
scatter(2*ones(1,length(feature_NMS_nonoverlap)),feature_sample_f(find_index(feature_NMS_nonoverlap),3));
subplot(1,2,2);
hold on;
title('conj cells');
