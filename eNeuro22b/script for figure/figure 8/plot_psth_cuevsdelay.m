...
for i=1:9
    ...
    temp_p(i)=plot(x_time,temp_psth(temp_t>plot_start & temp_t<plot_end),'color',color_map(i,:),'LineWidth',1.5);
...
%legend_handles=temp_p;
%hleg = legend(legend_handles,'-90','-45','-22.5','-11.25','0','11.25','22.5','45','90');
