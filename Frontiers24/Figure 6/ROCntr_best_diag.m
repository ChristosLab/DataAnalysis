function [ROCarea, ntrsBest, ntrsDiag] = ROCntr_best_diag(filename,TI,TW,startt,endt,r1r2,CorrErr) 
% function [ROCarea, ntrsBest, ntrsDiag, ROCarea_best, ROCarea_diag] = ROC_best_diag(filename,TI,TW,startt,endt,r1r2)
